        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsMainAdmin = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Admins",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "Email", "FirstName", "IsApproved", "IsMainAdmin", "LastName", "PasswordHash", "UpdatedAt" },
                values: new object[] { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "seed", "main.admin@clinic.com", "Main", true, true, "Admin", "PASTE_STATIC_HASH_HERE", null });
